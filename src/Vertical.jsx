...
const Vertical = () => {
    ...
    const deleteItem=(id)=>{
      ...
      <div className="veritcal-card">
      <FontAwesomeIcon 
                     className="delete-btn" onClick={()=>{deleteItem(curElem.id)}} icon={ faWindowClose} />
  <div className="veritcal-card-body">
  <img src="./image.jpg" className ="img-vertical" alt="..."/>
  
    <h5 className="veritcal-card-title">{curElem.title}</h5>
 
    <p className="veritcal-card-text">{curElem.body}</p>
